...
"""autogenerated by genpy from denso_robot_core/MoveValueActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveValueActionResult(genpy.Message):
  _md5sum = "5b70bf9b91fce5c335e4ebf1e187f32c"
  _type = "denso_robot_core/MoveValueActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','denso_robot_core/MoveValueResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveValueActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = denso_robot_core.msg.MoveValueResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = denso_robot_core.msg.MoveValueResult()
