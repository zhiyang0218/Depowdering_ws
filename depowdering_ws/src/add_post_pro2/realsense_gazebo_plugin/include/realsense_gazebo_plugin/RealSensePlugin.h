...
namespace gazebo
{
  ...
  #define DEPTH_CAMERA_NAME "D415_depth_optical_frame"
  #define COLOR_CAMERA_NAME "D415_color_optical_frame"
  #define IRED1_CAMERA_NAME "D415_ired1_optical_frame"
  #define IRED2_CAMERA_NAME "D415_ired2_optical_frame"
