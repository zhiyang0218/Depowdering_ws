...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'micro_epsilon_scancontrol_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cerlab/depowdering_ws/src/add_post_pro2/scancontrol/micro_epsilon_scancontrol_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cerlab/depowdering_ws/devel/.private/micro_epsilon_scancontrol_description/lib;/home/cerlab/depowdering_ws/devel/lib;/opt/ros/noetic/lib)
