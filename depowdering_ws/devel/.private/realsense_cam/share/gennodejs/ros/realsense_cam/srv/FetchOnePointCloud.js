...
class FetchOnePointCloudRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FetchOnePointCloudRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FetchOnePointCloudRequest
    let len;
    let data = new FetchOnePointCloudRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FetchOnePointCloudRequest(null);
    return resolved;
    }
};

class FetchOnePointCloudResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FetchOnePointCloudResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FetchOnePointCloudResponse
    let len;
    let data = new FetchOnePointCloudResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FetchOnePointCloudResponse(null);
...
module.exports = {
  Request: FetchOnePointCloudRequest,
  Response: FetchOnePointCloudResponse,
  md5sum() { return '12debe1ff97e2a037af192b4cc727ffc'; },
  datatype() { return 'realsense_cam/FetchOnePointCloud'; }
};
